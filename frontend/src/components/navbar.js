...
//     <Link to = "item"  className="navbar-brand" href="#"><p className='h2 dNavbar'>MEMORIES</p><span className='dNavbar'>{props.account.accountName}</span></Link >
...
//             <li><Link to = "/account"  className="dropdown-item dNavbar1" ><i className="fas fa-plus m-2"></i>Create </Link ></li>
